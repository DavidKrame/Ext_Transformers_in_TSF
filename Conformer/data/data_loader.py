...
class Reduced_dataset_elec(Dataset):
    def __init__(
        self,
        data_set,
        root_path,
    ...
    def __read_data__(self):
        ...
        if self.data_set == "elec":  # 24/5/5
            ...
            border1s = [
                0,
                7.5 * 30 * 24 - self.seq_len,
                7.5 * 30 * 24 + 3 * 30 * 24 - self.seq_len,
            ]
            border2s = [
                7.5 * 30 * 24,
                7.5 * 30 * 24 + 3 * 30 * 24,
        ...
        elif self.data_set == "ETTm1":  # 6/2/2
            border1s = [
                0,
                6 * 30 * 24 * 4 - self.seq_len,
                6 * 30 * 24 * 4 + 2 * 30 * 24 * 4 - self.seq_len,
        ...
        elif self.data_set == "ETTh1":  # 6/4/4
            border1s = [
                0,
                6 * 30 * 24 - self.seq_len,
                6 * 30 * 24 + 4 * 30 * 24 - self.seq_len,
        ...
        elif self.data_set == "ETTh2":  # 6/4/4
            border1s = [
                0,
                6 * 30 * 24 - self.seq_len,
                6 * 30 * 24 + 4 * 30 * 24 - self.seq_len,
