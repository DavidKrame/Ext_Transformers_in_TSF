...
parser.add_argument(
    "--train_only", type=bool, required=False, default=False, help="Not implemented"
)
parser.add_argument("--embed", type=str, default="timeF", help="Not implemented")
parser.add_argument(
...
parser.add_argument(
    ...
    required=True,
    default="Autoformer",
    help="model name, options: [Autoformer, Reformer, Informer, FEDFormer, Transformer]",
)
parser.add_argument(
    "--file_name",
    type=str,
...
parser.add_argument(
    "--batch_size", type=int, default=100, help="batch size of train input data"
)
