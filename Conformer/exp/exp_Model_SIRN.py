...
class Exp_Model:
    ...
    def train(self, setting):
        ...
        early_stopping = EarlyStopping_SIRN(patience=self.args.patience, verbose=True)
    ...
    def test(self, setting):
        ...
        preds = []
        trues = []
        for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_y_in) in enumerate(
            test_loader
        ):
            true, sample = self._process_one_batch(
    ...
    def _process_one_batch(
        self, dataset_object, batch_x, batch_y, batch_x_mark, batch_y_mark, batch_y_in
    ):
